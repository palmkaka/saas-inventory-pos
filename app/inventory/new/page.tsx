...
export default function NewProductPage() {
    ...
    useEffect(() => {
        async function fetchFieldDefinitions() {
            ...
            // Initialize dynamic attributes with empty values
            ...
            <header className="bg-slate-800/50 backdrop-blur-sm border-b border-slate-700/50 px-6 py-4 sticky top-0 z-10">
                <div className="max-w-4xl mx-auto flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mt-1">Fill in the product details below</p>
                    </div>
                </div>
            </header>
                ...
                {success && (
                    <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-emerald-400">Product created successfully! Redirecting...</p>
                        </div>
                    </div>
                )}
